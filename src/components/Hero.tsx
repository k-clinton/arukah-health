    ...
    <section className="relative min-h-screen flex items-center justify-center pt-32 pb-20 bg-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <Link
            href="/about"
            className="inline-block bg-[#FFB347]  hover:bg-orange-600 text-white font-bold py-5 px-14 rounded-full text-xl shadow-lg transform hover:scale-105 transition duration-300"
          >
            KNOW MORE →
          </Link>
        </motion.div>
